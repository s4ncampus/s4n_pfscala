...
\title{Introducción a la Programación Funcional con Haskell(Scala)\\Unidad 1. ¿Qué es la programación funcional?}
...
\section{Unidad 1. ¿Qué es la programación funcional?}

\subsection{Objetivos}

\begin{frame}
  \frametitle{Unidad 1. ¿Qué es la programación funcional?}
  \framesubtitle{Objetivos}
  
  \begin{itemize}
  \item<1-> Definir qué es la programación funcional.
    \begin{itemize}
    \item<2-> Mostrar los objetivos de los lenguajes de programación.
    \item<2-> Definir el concepto de paradigma de programación y los diferentes tipos.
    \item<3-> Definir los conceptos relevantes de la programación funcional.
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Objetivos de los lenguajes de programación}
    \begin{itemize}
    \item<1-> Son herramientas para escribir programas.
    \item<2-> Nos permite comunicarnos con el computador físico y decirle que hacer.
    \item<3-> Nos permite comunicarnos con otros programadores.
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Definición de los lenguajes de programación}
    \begin{itemize}
    \item<1-> No hay una definición formal.
    \item<2-> Pero si hay una forma de estructurar la definición de un
      ...
      \item<5-> Pragmática.
      \end{itemize}
    \item<6-> Cómo hacer programas en un lenguaje de programación: \alert{Paradigmas de programación}.
    \end{itemize}
  \end{block}
\end{frame}
