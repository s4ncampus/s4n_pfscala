...
\title{Introducción a la Programación Funcional\\Módulo 0\\Unidad 1. Paradigmas de programación y programación funcional}
...
\begin{frame}
  ...
  \begin{itemize}
  \item<1-> Comprenderás que son los lenguajes de programación
  \item<2-> Identificarás cuáles son los paradigmas de programación
  \item<3-> Identificarás que son los lenguajes funcionales
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Definición de los lenguajes de programación}
    \begin{itemize}
    \item<2-> No hay una definición formal de un lenguaje de programación
    \item<3-> Entonces: \alert{¿Qué lo define?}
      \begin{itemize}
      \item<4-> Gramática,
      \item<4-> Semántica,
      \item<4-> Pragmática.
      \end{itemize}
    \item<5-> La forma de razonar de cómo escribir un programa: \alert{Modelo de computador} y \alert{Paradigmas de programación}.
    \end{itemize}
  \end{block}
\end{frame}
