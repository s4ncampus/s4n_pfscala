...
\title{Formato de las imágenes Unidad de aprendizaje Scala\\Módulo 0. Unidad 1. Paradigmas de programación y programación funcional}
...
\section{Módulo 0.\\Unidad 1. Paradigmas de programación y programación funcional}

\subsection{Modelo de computador y lenguajes de programación}

En el vídeo inicial de la unidad 1 va aparecer el siguiente \emph{slide}~\ref{fig:slide-video}.

\begin{figure}[h]
  \centering
  \includegraphics[width=15cm,height=15cm]{../../../../imagenes/ModeloComputador-01}
  \caption{Modelo de computador y lenguajes de programación 1}
  \label{fig:slide-video}
\end{figure}

La idea es mostrar la parte izquierda, luego la parte del centro y
finalmente la parte la derecha. Las dos primeras gráficas, están
compuesta de un círculo y una cuadrado; la primera representa un
programa, el segundo representa un computador. En la tercera gráfica,
es una versión de las dos anteriores una sobre la otra, pero indicando
que la que esta sobre es un lenguaje de alto nivel, mientras que la
que esta debajo, obvio una de bajo nivel.
...
\begin{figure}[h]\centering
  ...
  \caption{Modelo de computador}
  \label{fig:slide-video-2}
\end{figure}

En la siguiente figura es la forma que va a aparecer el \emph{slide}
en la pantalla~\ref{fig:slide-video-3}

\begin{figure}[h]
  \centering
  \includegraphics[width=15cm,height=15cm]{../../../../imagenes/ModeloComputador-01}
  \caption{Modelo de computador y lenguajes de programación 1}
  \label{fig:slide-video-3}
\end{figure}

Hay dos figuras aparece primero la de la izquierda, luego la derecha. Importante notar que ambas figuras separan dos espacios: los lenguajes de alto nivel y los lenguajes de bajo nivel. ¿Es posible utilizar una forma de resaltar ambos espacios? Al final las figuras aparecen así:
...
\begin{figure}[h]\centering
  ...
  \end{multicols}
  \caption{Modelo de computador y lenguajes de programación 2}
  \label{fig:slide-video-4}
\end{figure}
% \subsection{Paradigmas de programación}

% \begin{frame}
%   \frametitle{Unidad 1. Paradigmas de programación y programación funcional}
...
%   \begin{itemize}
%   \item<1-> El modelo es computación es el computador físico.
%   \item<2-> Se consulta y se modifica variables en memoria.
...
%   \begin{itemize}
%   \item<1-> Su modelo de computación no es el computador físico.
%   \item<2-> El concepto de variables es matemático.
%   \item<3-> Un programa es una expresión.
%   \item<4-> Un programa es un conjunto de hechos e inferencia sobre ellos.
%   \item<5-> Los datos y los programas son equivalentes.
%   \item<6-> Dos alternativas:
%     \begin{itemize}
